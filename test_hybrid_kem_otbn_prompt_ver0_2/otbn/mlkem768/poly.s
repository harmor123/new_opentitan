...
poly_getnoise_eta_1:
  ...
  /* SHAKE256 session (official xof.s driver): absorb seed || nonce, squeeze 128B */
  add x3, x0, x10              /* x3 = seed ptr */
  add x9, fp, x13              /* x9 = nonce addr */
  bn.xor w31, w31, w31
  ...
  /* Squeeze 4 * 32B into noise buffer (x6 saved at 0(x2)) */
  lw   x20, 0(x2)
  LOOPI 4, 3
