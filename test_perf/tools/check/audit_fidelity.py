...
用法:
    python3 test_perf/tools/check/audit_fidelity.py --version ver1_1
    python3 test_perf/tools/check/audit_fidelity.py --version ver0_1 --rows-only-noisy   # 只打印有问题/未覆盖的
"""
import argparse
import json
import re
...
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "gen"))   # fix_controls.py 在 tools/gen/
