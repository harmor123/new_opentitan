...
用法:
    python3 test_perf/tools/check/otbn_symbol_check.py --build <BUILD 路径> [--only 子串]
    python3 test_perf/tools/check/otbn_symbol_check.py --files a.s b.s ...
    python3 test_perf/tools/check/otbn_symbol_check.py --build <BUILD> --refs     # 顺带打印每文件的外部引用
