...
用法（Linux）:
    python3 test_perf/tools/check/fidelity_check.py --config test_perf/harness_config.yaml --version ver0_1
    python3 test_perf/tools/check/fidelity_check.py --config ... --version ver1_1 --phase encap_noise_x7 [--seed 1234]
