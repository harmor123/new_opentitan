...
用法:
    python3 test_perf/tools/gen/gen_xof_stream_from_rho.py --version ver0_2            # 干跑：只打印校验表
    python3 test_perf/tools/gen/gen_xof_stream_from_rho.py --version ver0_2 --write    # 写回包内流文件（备份为 .bak.s）
    python3 test_perf/tools/gen/gen_xof_stream_from_rho.py --version ver0_1 --nonce-order i,j   # 反序试算
"""
import argparse
import hashlib
import json
