...
用法:
    python3 test_perf/tools/gen/gen_harness.py --version ver1_1 --out-dir <包目录> --build-snippet
    python3 test_perf/tools/gen/gen_harness.py --version ver0_2 --out-dir <包目录> --dry-run
 ...
 * {note}
 *
 * 本文件由 test_perf/tools/gen/gen_harness.py 生成（--version {version}）。
...
def main():
    ...
    sys.path.insert(0, str(Path(__file__).resolve().parent))   # harness_specs*.py 同目录
