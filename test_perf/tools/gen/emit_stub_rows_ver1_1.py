...
用法: python3 test_perf/tools/gen/emit_stub_rows_ver1_1.py [--out-dir <包目录>]
"""
import argparse
import sys
...
def main() -> int:
    ...
    print("\n还需：① 生成流文件 test_perf/tools/gen/dump_xof_stream.py；② 加 BUILD 目标 + config 阶段行（closure:false）")
    return 0
