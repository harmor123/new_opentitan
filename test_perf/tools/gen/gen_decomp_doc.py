...
用法:
    python3 test_perf/tools/gen/gen_decomp_doc.py --version ver0_1 --json logs_hkem/ver0_1_profiling/re_ver0_1.json \
...
def main() -> int:
    ...
    W("| 单 ELF 诊断 | `test_perf/tools/diag/iss_diag.py` |")
    W("| 文档生成 | `test_perf/tools/gen/gen_decomp_doc.py`（数字全部取自 JSON，不手抄） |")
