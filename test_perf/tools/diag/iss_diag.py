...
用法（Linux 侧）:
    python3 test_perf/tools/diag/iss_diag.py --target //<pkg>:<目标名>
    python3 test_perf/tools/diag/iss_diag.py --elf bazel-bin/<...>.elf
    python3 test_perf/tools/diag/iss_diag.py --target //...:mlkem768_encap_h_ek_profiling \\
