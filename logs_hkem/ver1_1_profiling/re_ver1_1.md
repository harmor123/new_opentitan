...
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| ver1_1 | keygen_ntt | 13,902 | 5,364 | 8,538 | 1,668 | 2,720 | 4,388 | Alg.13 L16–17 | Direct |
| ver1_1 | keygen_basemul_basemul_acc | 26,979 | 8,145 | 18,834 | 2,484 | 5,792 | 8,276 | Alg.13 L18 | Direct |
| ver1_1 | keygen_poly_add | 750 | 444 | 306 | 1,660 | 6,304 | 7,964 | Alg.13 L18 | Direct |
...
| ver1_1 | keygen_hash_h | 2,220 | 1,625 | 595 | 668 | 5,312 | 5,980 | Alg.16 L3 | Direct |
| ver1_1 | keygen_sha3_init_update_final | 355 | 263 | 92 | 676 | 4,288 | 4,964 | Alg.13 L1 / G(d‖k) | Direct |
...
| ver1_1 | encap_hash_g | 362 | 267 | 95 | 692 | 4,224 | 4,916 | Alg.17 L2 / G(m‖H(ek)) | Direct |
...
| ver1_1 | decap_shake_z_ct | 2,135 | 1,559 | 576 | 660 | 1,312 | 1,972 | Alg.18 L9 / J(z‖c) | Direct |
| ver1_1 | encap_intt | 2,739 | 963 | 1,776 | 2,828 | 3,264 | 6,092 | Alg.14 L19,L21 | Direct (单次) |
| ver1_1 | encap_pack_ciphertext | 13,038 | 11,156 | 1,882 | 1,236 | 3,296 | 4,532 | Alg.14 L22–24 | Direct |
| ver1_1 | encap_unpack_pk | 23,093 | 22,627 | 466 | 708 | 3,584 | 4,292 | Alg.14 L2–3 | Direct |
...
| ver1_1 | keygen_poly_gen_matrix_shake | 10,024 | 7,736 | 2,288 | 4,524 | 4,192 | 8,716 | Alg.7 子分解 / XOF 路径 | Direct |
